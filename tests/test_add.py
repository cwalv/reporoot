...
class TestAddFromLocal:
    ...
    def test_add_duplicate_raises(self, workspace_with_project: tuple[Path, Path]):
        workspace, repo = workspace_with_project
        os.chdir(workspace)
        # test-owner/test-repo already exists from fixture
        with pytest.raises(SystemExit, match="already exists"):
            run(source="https://github.com/test-owner/test-repo.git")
